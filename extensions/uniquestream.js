...
// ==/AniDeskExtension==
(function(){
const _ID='uniquestream',_N='UniqueStream Anime',_EP='gogoanime';
const _APIS=[
...
class _Src extends AnimeSource {
  constructor(){super({id:_ID,name:_N,lang:'en',baseUrl:'https://anime.uniquestream.net',icon:'📺',version:'1.0'});}
